...
if __name__ == "__main__":
    ...
    python_user_query = "how can i use ConversationSummaryMemory to gather the data from the sql database and add it to ChatOllama"
    ...
    print(sql_manager.get_project_chat_context(python_project_path))
